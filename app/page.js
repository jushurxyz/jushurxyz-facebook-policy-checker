...
export default function Home() {
  ...
  function renderLinkedReport(report) {
    ...
    const replacements = [
      ...
      {
        label: "Articolo 4",
        url: "https://transparency.meta.com/policies/community-standards/discrimination/"
      },
      {
    ...
    replacements.forEach((item) => {
      const regex = new RegExp(item.label, "gi");

      linkedText = linkedText.replace(
        regex,
        `<a href="${item.url}" target="_blank" rel="noopener noreferrer" style="color:#93c5fd;text-decoration:underline;font-weight:bold;">${item.label}</a>`
      );
    });
  ...
  async function analyzeContent() {
    ...
    try {
      ...
      const analysisResult =
        data.result || "Nessun risultato ricevuto.";
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Analizza contenuti Facebook, testi,
          screenshot e immagini per rilevare
          possibili violazioni delle Regole della
          Community Meta tramite AI.
        </p>
        ...
        >
          ...
          {showDisclaimer && (
            ...
            >
              ...
              esclusivamente un’analisi preliminare
              automatizzata basata su modelli di
              intelligenza artificiale e non
              rappresenta una valutazione ufficiale
              di Meta/Facebook.
            </div>
          )}
        </div>
