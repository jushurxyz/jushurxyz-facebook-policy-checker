  ...
  return (
    ...
    >
      ...
      <div style={{ maxWidth: 1100, margin: "0 auto" }}>
        ...
        >
          Analizza contenuti Facebook, testi, screenshot e immagini per rilevare
          possibili violazioni delle Regole della Community Meta tramite AI.
        </p>
        ...
        <div style={{ marginTop: 24, marginBottom: 30 }}>
          ...
          >
            ...
            <span style={{ fontSize: 24 }}>{showDisclaimer ? "−" : "+"}</span>
          </button>
